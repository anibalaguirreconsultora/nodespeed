...
/**
 * Api services for the `WidgetA` model.
 */
@Injectable()
export class WidgetAApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `WidgetA` object.)
   * </em>
   */
  public getStore(id: any, refresh: any = {}): Observable<any> {
