...
export class CustomerApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public createProfile(id: any, data: any = {}): Observable<any> {
   ...
   * </em>
   */
  public updateProfile(id: any, data: any = {}): Observable<any> {
   ...
   */
  public destroyProfile(id: any): Observable<any> {
   ...
   * </em>
   */
  public createManyProfile(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customers/:id/profile";
    let _routeParams: any = {
