...
/**
 * Api services for the `WidgetB` model.
 */
@Injectable()
export class WidgetBApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `WidgetB` object.)
   * </em>
   */
